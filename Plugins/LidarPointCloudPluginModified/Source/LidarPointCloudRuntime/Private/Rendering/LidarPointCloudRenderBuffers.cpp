...
void FLidarPointCloudIndexBuffer::InitRHI(FRHICommandListBase& RHICmdList)
{
	...
	const FRHIBufferCreateDesc CreateDesc =
		FRHIBufferCreateDesc::CreateIndex<uint32>(TEXT("FLidarPointCloudIndexBuffer"), Capacity * 7 * sizeof(uint32))
...
{
	const FRHIBufferCreateDesc CreateDesc =
		FRHIBufferCreateDesc::CreateVertex<uint32>(TEXT("FLidarPointCloudRenderBuffer"), Capacity * sizeof(uint32))
...
void FLidarPointCloudVertexFactory::FPointCloudVertexBuffer::InitRHI(FRHICommandListBase& RHICmdList)
{
	...
	const FRHIBufferCreateDesc CreateDesc =
		FRHIBufferCreateDesc::Create(TEXT("FPointCloudVertexBuffer"), BufferSize, (sizeof(FLidarPointCloudPoint) - sizeof(uint32)), EBufferUsageFlags::VertexBuffer)
