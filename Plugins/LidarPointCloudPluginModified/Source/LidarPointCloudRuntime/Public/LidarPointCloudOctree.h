...
public:
	...
	void GetPointsInSphere(TArray<FLidarPointCloudPoint>& SelectedPoints, const FSphere& Sphere, const bool& bVisibleOnly, const FTransform* LocalToWorld) const;
	...
	void ApplyClassificationToAllPoints(const int32& ClassificationID, const bool& bVisibleOnly);
...
private:
	...
	template <typename T>
	void GetPointsInSphere_Internal(TArray<FLidarPointCloudPoint*, T>& SelectedPoints, const FSphere& Sphere, const bool& bVisibleOnly, const FTransform* LocalToWorld) const;
	template <typename T>
